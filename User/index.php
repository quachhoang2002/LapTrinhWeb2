                ...
                <div class="row gx-5">
                    <div class="col-lg-4 mb-5">
                        <div class="card h-100 shadow border-0">
                            <img class="card-img-top" src="Home/media/photos/vn-galaxy-s10-sm-g973-sm-g973fzwdxxv-frontprismwhite-thumb-145261779.webp" alt="..." />
                            <div class="card-body p-4">
                                <div class="badge bg-primary bg-gradient rounded-pill mb-2">News</div>
                                <a class="text-decoration-none link-dark stretched-link" href="{% url 'home:ProductDetail' 2 %}"><h5 class="card-title mb-3">Blog post title</h5></a>
                    ...
                    <div class="col-lg-4 mb-5">
                        <div class="card h-100 shadow border-0">
                            <img class="card-img-top" src="Home/media/photos/iphone-xs-max-gold-600x600.jpg" alt="..." />
                            <div class="card-body p-4">
                                <div class="badge bg-primary bg-gradient rounded-pill mb-2">Media</div>
                                <a class="text-decoration-none link-dark stretched-link" href="{% url 'home:ProductDetail' 13 %}"><h5 class="card-title mb-3">Another blog post title</h5></a>
                    ...
                    <div class="col-lg-4 mb-5">
                        <div class="card h-100 shadow border-0">
                            <img class="card-img-top" src="Home/media/photos/iPhone-13-Pro-Max-2.jpg" alt="..." />
                            <div class="card-body p-4">
                                <div class="badge bg-primary bg-gradient rounded-pill mb-2">News</div>
                                <a class="text-decoration-none link-dark stretched-link" href="{% url 'home:ProductDetail' 8 %}"><h5 class="card-title mb-3">The last blog post title is a little bit longer than the others</h5></a>
